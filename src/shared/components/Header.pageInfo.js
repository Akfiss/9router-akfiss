// Pure page-metadata resolver behind Header.js — kept in a sibling module
...
// export — so getPageInfo() can't live inside Header.js itself and still be
// unit-testable. Header.js imports and calls this; nothing here is
